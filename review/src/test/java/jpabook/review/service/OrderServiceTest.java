...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        assertEquals("주문한 가격 = 가격 * 수량", 10000*orderCount, getOrder.getTotalPrice());
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문 취소 시 재고 원복", 10, book.getStockQuantity());
    ...
    private Member createMember() {
        ...
        member.setName("김회원");
        member.setAddress(new Address("주소시", "어쩌구", "123-123"));
        em.persist(member);
        return member;
    }
